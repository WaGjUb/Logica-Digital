...
Observação:
As variáveis que são passadas ao make ou devem ser escritas sem espaço (IN=porta1,porta2,portaN) ou com espaços
e entre aspas (IN="porta1, porta2, portaN"), pois ao encontrar um espaço o make irá entender que 
ali acaba a definição da variável.
